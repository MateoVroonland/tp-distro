...
func (c *CreditsJoiner) JoinCredits(routingKey int) error {
	...
	// 		moviesConsumer, err := utils.NewConsumerQueueWithRoutingKey(c.conn, "filter_q4_client_"+msg.ClientId, "filter_q4_client_"+msg.ClientId, strconv.Itoa(routingKey), "internal_filter_q4_client_"+msg.ClientId)
	// 		if err != nil {
	...
	// 		creditsConsumer, err := utils.NewConsumerQueueWithRoutingKey(c.conn, "credits_joiner_client_"+msg.ClientId, "credits_joiner_client_"+msg.ClientId, strconv.Itoa(routingKey), "internal_credits_joiner_client_"+msg.ClientId)
	// 		if err != nil {
